...
// ---------- constants ----------
const ASSET_TYPES = ["คอมพิวเตอร์CPU", "โน้ตบุ๊ก", "หน้าจอคอมพิวเตอร์", "เครื่องพิมพ์ลาเบลGK888t" ,"เครื่องพิมพ์ลาเบลX-Printer","เครื่องพิมพ์ลาเบลG-Printer","เครื่องพิมพ์ลาเบลCODE SOFT","PDA IData95W","PDA IDataKs3","PDA IDataKs3Pro","ปืนสแกนพัสดุ","โทรศัพท์" ,"เครื่องบันทึกNVR", "อุปกรณ์อื่นๆ"];
const ASSET_STATUS = ["ใช้งานอยู่", "จัดเก็บในคลัง", "ส่งซ่อม", "ปลดระวาง"];
const TICKET_STATUS = ["แจ้งซ่อมอุปกรณ์", "กำลังดำเนินการซ่อม", "รอชิ้นส่วน/อะไหล่", "ซ่อมเสร็จ","อยู่ระหว่างส่งคืนให้สาขา", "ปิดงาน"];
const PRIORITY = ["ต่ำ", "ปานกลาง", "สูง", "ด่วนมาก"];
const NORTH_PROVINCES = ["เชียงใหม่","เชียงราย","ลำพูน","ลำปาง","แพร่","น่าน","พะเยา","แม่ฮ่องสอน","อุตรดิตถ์","ตาก","สุโขทัย","พิษณุโลก","พิจิตร","เพชรบูรณ์","กำแพงเพชร","นครสวรรค์","ชัยนาท","ลพบุรี","สิงห์บุรี","อุทัยธานี","อ่างทอง"];
...
const STATUS_COLOR = {
  "ใช้งานอยู่": "#5B9DF9", "จัดเก็บในคลัง": "#4ADE80", "รอชิ้นส่วน/อะไหล่": "#F0A83C", "ปลดระวาง": "#6B7280",
  "แจ้งใหม่": "#F0A83C", "กำลังดำเนินการซ่อม": "#5B9DF9", "รอชิ้นส่วน/อะไหล่": "#E879F9", "ซ่อมเสร็จ": "#4ADE80","อยู่ระหว่างส่งคืนให้สาขา": "#ff5722", "ปิดงาน": "#6B7280",
};
